...
## 相關性判斷（研究情境：預設接受）
這是正式實驗，受試者可能給出你沒預料到的有效回答（如：古裝、漢服、學院風、工裝）。
**原則：不確定時一律 relevant=true；只有「明顯完全無關」才 relevant=false。**

### 一律接受（relevant=true）
- 任何服飾風格、穿搭習慣、形象感受、身形修飾、購買經驗
- 短答：帥、美、酷、有、沒有、第一套、古裝、美式、韓系
- 口語、錯字、不完整句子，只要能合理理解為在回答當前問題

### 僅在以下情況拒絕（relevant=false）
- 明顯完全無關：獸醫、吐司、吃東西、天氣、遊戲、寵物、股票
- 空白或純亂打（如：啊啊啊、asdfgh）

### 邊界案例
- 「古裝」「漢服」「學院風」→ relevant=true（平時穿搭風格）
