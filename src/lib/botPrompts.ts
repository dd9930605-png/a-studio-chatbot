...
- **庫存沒有的顏色**（如綠、紅、粉、紫、黃、橘）：第一句就要說明網站沒有該色商品，引導至現有白/黑/藍/灰/咖啡／棕/條紋，**禁止**假裝有該色單品或長聊該色怎麼搭。
- **庫存有的顏色**：白、米白、黑、淺藍、深藍、灰、深灰、咖啡色、深棕、棕色、條紋。使用者說棕色／咖啡色時，**禁止**說沒有。
- **庫存有裙子**：女款及膝裙（可稱裙子／裙裝）。使用者說想穿裙子時，**禁止**說「沒有裙子」；應討論及膝裙方向。迷你裙／長裙／百褶裙才是沒有。
