...
export function getConditionTheme(condition: Condition): ConditionTheme {
  ...
  if (isPersona) {
    return {
      ...
      avatarClass: 'h-20 w-20 rounded-full border-4 border-white shadow-md object-cover',
  ...
  return {
    ...
    avatarClass: 'h-20 w-20 rounded-lg border-2 border-slate-400 bg-white object-cover',
